...
/* ========================= Map panel ========================= */
function MapPanel({ stops, vehicles, directionsResult, routePaths, onStopClick, stopActionLabel }) {
  ...
  }, [stops, vehicles, routePaths, mapReady]);
      ...
      <Panel className="flex min-h-[420px] flex-col overflow-hidden p-2 xl:min-h-0">
        ...
        <div className="min-h-[340px] flex-1">
          <MapPanel stops={stops.map(s => ({ ...s, name: pickName(s.zh, s.en, lang) }))} vehicles={visibleVehicles} routePaths={routePaths}
            onStopClick={(s) => onShowStops && onShowStops(s.zh)} stopActionLabel={t.viewRoutes} />
        </div>
      </Panel>
    </div>
  );
